    ...
    <>
        ...
        >
            <div id="info-subheader" className="pr-slidehead-severe-city-info-r font-frutiger57-cond flex flex-row flex-nowrap justify-between text-subhead h-subhead z-subheader drop-shadow-subhead leading-subheader relative text-white w-full p-slidehead">
                ...
                <span
                    id="subhead-city"
                    className="transform -translate-y-43-5 scale-x-105-9 scale-y-100 font-frutiger text-subhead-city pt-0 origin-right right-subhead-city-r absolute top-2/4"
            ...
            <div
                id="noreport"
                className="transform translate-x-0 translate-y-60px scale-x-114-5 scale-y-100 origin-left absolute whitespace-nowrap font-frutiger57-cond pt-noreport-t pl-noreport-l text-white text-noreport drop-shadow-default z-noreport hidden"
            >
                No Report
            </div>
            <div
                id="tempunavailable"
                className="transform translate-x-0 translate-y-60px scale-x-114-5 scale-y-100 origin-left absolute whitespace-nowrap font-frutiger57-cond pt-noreport-t pl-tempunavailable-l text-white text-tempunavailable drop-shadow-default z-noreport hidden"
            >
                Temporarily Unavailable
            </div>
            <div id="infoslide-content-severe-forecast" className="h-full min-h-full w-full flex-1 z-0 flex-row top-severe-forecast text-severe-forecast hidden">
