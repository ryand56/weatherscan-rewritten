...
const Intro = ({ winSize, callback }: IntroProps) => {
  ...
  return (
    <div
      id="intro"
      ref={mainRef}
      className="relative top-1/2 left-1/2 overflow-hidden w-main h-main bg-white"
    >
      <div
        id="blackbar"
        className="h-[23.5%] w-full absolute bottom-0 bg-[#161418]"
      >
        <div className="absolute w-[400px] left-[8.05%] top-[4.6%] flex flex-row flex-col">
          <div className="whitespace-nowrap relative font-frutiger font-semibold text-[#d8c422] text-[31.5px] tracking-[1px] pt-6">
            headend id:
          </div>
          <div className="whitespace-nowrap relative font-frutiger font-semibold text-[#d8c422] text-[31.5px] tracking-[1px] pt-6">
            serial number:
        ...
        <img
          className="object-contain absolute w-[500px] h-[175px] right-[1.9%] -top-[9px]"
          src="/images/weatherlogos.png"
          alt="weatherscan"
        />
      </div>
      ...
      <div id="locationsettingspane" className="pt-[200px] hidden">
        <div
          id="weathertitle"
          className="absolute w-full text-center text-[56px] top-[16px]"
        >
          Location Settings
        </div>
      </div>
      <img
        ref={intellistarRef}
        className="object-contain object-center w-[625px] h-[205px] block m-[0px] m-auto mt-[440px]"
        src="/images/intellistarlogo.png"
        alt="intellistar"
      />
    </div>
  );
